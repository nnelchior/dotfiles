...
local function source_matugen()
  ...
  local matugen_path = os.getenv("HOME") .. "/.config/nvim/themes/matugen.lua"  -- dofile doesn't expand $HOME or ~
...
local function auxiliary_function()
  ...
  local matugen_path = os.getenv("HOME") .. "/.config/nvim/themes/matugen.lua"
  source_matugen()
